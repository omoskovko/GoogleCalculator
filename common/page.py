...
class BasePage(object):
    ...
    def wait_until(self, by, value, timeout=90, vDrv=None):
        ...
        return WebDriverWait(wDriver, timeout,
                             ignored_exceptions=(InvalidElementStateException, NoSuchElementException,)).until(
    ...
    def wait_until_not(self, by, value, timeout=90, vDrv=None):
        ...
        WebDriverWait(wDriver, timeout,
                      ignored_exceptions=(InvalidElementStateException, NoSuchElementException,)).until_not(
    ...
    def wait_for_text_in_element(self, text_value, by, value, timeout=90, vDrv=None):
        ...
        vMessage = "Element By='{0}', Value={1}: text '{2}' is not found".format(by, value, text_value)    
        return WebDriverWait(wDriver, timeout,
                             ignored_exceptions=(InvalidElementStateException, NoSuchElementException,)).until(
                    lambda driver, t_str=text_value: t_str in driver.find_element(by, value).text, 
                    vMessage)
    ...
    def wait_clear(self, by, value, timeout=90, vDrv=None):
        ...
        vMessage = "Element By='{0}', Value={1} is not currently interactable and may not be manipulated".format(by, value)    
        return WebDriverWait(driver=wDriver, timeout=timeout,
                             ignored_exceptions=(InvalidElementStateException, NoSuchElementException,)).until(clear_field, vMessage)
    ...
    def set_input_field(self, by, locator, sValue, timeout=90, vDrv=None):
        ...
        vMessage = "Element By='{0}', Value={1} is not currently interactable and may not be manipulated".format(by, locator)    
        return WebDriverWait(driver=wDriver, timeout=timeout,
                             ignored_exceptions=(InvalidElementStateException, NoSuchElementException,)).until(set_text_val, vMessage)
    ...
    def click_on_field(self, by, locator, timeout=90, vDrv=None):
        ...
        vMessage = "Element By='{0}', Value={1} is not currently interactable and may not be manipulated".format(by, locator)    
        return WebDriverWait(driver=wDriver, timeout=timeout,
                             ignored_exceptions=(InvalidElementStateException, NoSuchElementException,)).until(click_field, vMessage)
